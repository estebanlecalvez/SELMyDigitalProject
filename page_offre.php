...
<?php include('header.html');?>
    <div style="background-color: black">
        ...
        <div class="row">
            ...
            <div class="alert col-sm" style="background-color: #d9d9d9">
                ...
                <div class="container">
                    ...
                    <div class="container">
                        <div class="title">
                            <br/>
                            <b>Nom de la personne : </b> Patricia
                            <br/>
                            <br/>
                            <b>Age de la personne : </b> 56
                            <br/>
                            <br/>
                            <b>Contact : </b>
                            <button type="button" class="btn btn-success">Afficher numéro</button>
